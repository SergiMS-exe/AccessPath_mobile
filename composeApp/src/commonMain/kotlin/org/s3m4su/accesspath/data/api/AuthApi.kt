...
object AuthApi {
    // Tanto login como register devuelven la misma forma: LoginResponse directo
    // (sin envelope). Ver backend internal/handlers/user_handler.go (issueTokens).
    ...
    suspend fun register(username: String, email: String, password: String): Result<LoginResponse> = runCatching {
